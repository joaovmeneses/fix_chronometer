export default [
  ...
  },
  {
    path: '/pages/ciclo/',
    name: 'index-ciclo',
    component: () => import('@/views/pages/ciclo/Index.vue'),
  },
  {
    path: '/pages/ciclo/inserir/',
    name: 'inserir-ciclo',
    component: () => import('@/views/pages/ciclo/Inserir.vue'),
  },
  {
    path: '/pages/ciclo/doZero/:id',
    name: 'editar-do-zero',
    component: () => import('@/views/pages/ciclo/doZero/Editar.vue'),
  },
  ...
  // *===============================================---*
  {
    path: '/pages/ciclo/porConcurso',
    name: 'inserir-por-concurso',
    component: () => import('@/views/pages/ciclo/porConcurso/Inserir.vue'),
  },
  {
    path: '/pages/ciclo/concurso/inserir',
    name: 'inserir-concurso',
    component: () => import('@/views/pages/ciclo/concurso/Inserir.vue'),
  },
  {
    path: '/pages/ciclo/porArea',
    name: 'inserir-por-area',
    component: () => import('@/views/pages/ciclo/porArea/Inserir.vue'),
  },
]
